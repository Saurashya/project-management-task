  ...
  return (
    <main>
      <header className='flex items-center w-full justify-between'>
        ...
        <button className='font-semibold btn-success text-white px-4 py-1 rounded-full hover:scale-105 hover:cursor-pointer transition-all ease-in-out text-sm' onClick={()=>{setIsModalOpen(true)}}>Add Project</button>
      </header>
